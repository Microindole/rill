...
public class SemanticAnalyzerTest {
    ...
    public void testAnalyzeValidStatements() {
        ...
        semanticAnalyzer.analyze(
            parseSql("INSERT INTO users (id, name) VALUES (100, 'test');"), mockRootSession);
    ...
    public void testAnalyzeInsert_ColumnNotFound() {
        ...
        System.out.println(
            "Goal: Expect a SemanticException for inserting into a non-existent column.");
        try {
            // 错误：插入一个不存在的列
    ...
    public void testAnalyzeInsert_TypeMismatch() {
        ...
        System.out.println(
            "Goal: Expect a SemanticException for inserting a value with mismatched type.");
        try {
            // 错误：插入的值类型不匹配
            semanticAnalyzer.analyze(
                parseSql("INSERT INTO users (id) VALUES ('a string');"), mockRootSession);
        } finally {
            System.out.println("Result: Test threw expected exception.\n");
        }
    }
