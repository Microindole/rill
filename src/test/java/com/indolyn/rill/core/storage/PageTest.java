...
public class PageTest {
    ...
    void testInsertAndGetTuple() {
        ...
        // 3. 创建两条 Tuple
        Tuple tuple1 = new Tuple(Arrays.asList(new Value(1), new Value("Alice"), new Value(20)));
        Tuple tuple2 = new Tuple(Arrays.asList(new Value(2), new Value("Bob"), new Value(25)));
