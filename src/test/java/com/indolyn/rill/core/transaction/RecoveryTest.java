...
/**
 * 专门用于测试崩溃恢复功能的集成测试. 严格遵循 "Setup -> Crash -> Recover -> Verify" 的流程.
 */
public class RecoveryTest {
    ...
    void testRecoveryAfterCrashDuringTransaction() throws Exception {
        ...
        System.out.println(
            "--- Uncommitted operations logged. Simulating CRASH now (by not committing and not closing) ---");
    ...
    private void executeSqlInTransaction(QueryProcessor qp, String sql, Transaction txn)
        ...
        Method executeMethod =
            executionEngine.getClass().getMethod("execute", PlanNode.class, Transaction.class);
