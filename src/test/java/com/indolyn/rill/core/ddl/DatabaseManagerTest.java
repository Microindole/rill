...
public class DatabaseManagerTest {
  ...
  void testCreateExistingDatabaseThrowsException() {
    ...
    assertTrue(
        ...
        "Exception message should indicate that the database already exists.");
  }
  ...
  void testListDatabases() {
    ...
    assertTrue(
        databases.contains(TEST_DB_NAME),
        "List of databases should include the newly created one.");
  }
  ...
  void testDropNonExistentDatabaseThrowsException() {
    ...
    assertTrue(
        ...
        "Exception message should indicate that the database does not exist.");
  }

  @Test
  void testGetDbFilePath() {
    System.out.println("--- Test: Get DB File Path ---");
    String expectedPath = "data" + File.separator + TEST_DB_NAME + File.separator + "rill.data";
    assertEquals(
        expectedPath,
        DatabaseManager.getDbFilePath(TEST_DB_NAME),
        "The generated DB file path is incorrect.");
  }
