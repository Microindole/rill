...
import com.indolyn.rill.core.storage.buffer.replacement.*;
...
public class BufferPoolManager {
  ...
  @Getter private final Map<PageId, Page> pageTable;
  private final BufferPoolReplacer replacer;

  @Getter private int hitCount = 0;
  @Getter private int missCount = 0;
