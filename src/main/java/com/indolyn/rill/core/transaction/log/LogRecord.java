// src/main/java/org/csu/rill/transaction/log/LogRecord.java
...
public class LogRecord {
  ...
  public LogRecord(
      int transactionId, long prevLSN, LogType logType, String tableName, RID rid, Tuple tuple) {
  ...
  public LogRecord(
      int transactionId, long prevLSN, LogType logType, String tableName, Schema schema) {
    this.transactionId = transactionId;
    this.prevLSN = prevLSN;
    this.logType = logType;
    this.tableName = tableName;
  ...
  public LogRecord(
      int transactionId, long prevLSN, LogType logType, String tableName, Column newColumn) {
    this.transactionId = transactionId;
    this.prevLSN = prevLSN;
    this.logType = logType;
    this.tableName = tableName;
