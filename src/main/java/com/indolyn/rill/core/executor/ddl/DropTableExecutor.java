...
public class DropTableExecutor implements TupleIterator {
    ...
    public DropTableExecutor(
        DropTablePlanNode plan, Catalog catalog, Transaction txn, LogManager logManager) {
        this.plan = plan;
    ...
    public Tuple next() throws IOException {
        ...
        return new Tuple(
            Collections.singletonList(
                new Value("Table '" + plan.getTableName() + "' and its indexes dropped.")));
    }
