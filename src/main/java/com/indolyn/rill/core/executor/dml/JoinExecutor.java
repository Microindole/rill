// rill/executor/JoinExecutor.java
...
import com.indolyn.rill.core.compiler.planner.plan.query.JoinPlanNode;
import com.indolyn.rill.core.compiler.planner.plan.query.SeqScanPlanNode;
import com.indolyn.rill.core.engine.ExpressionEvaluator;
...
public class JoinExecutor implements TupleIterator {
    ...
    public JoinExecutor(JoinPlanNode plan, TupleIterator leftChild, TupleIterator rightChild) {
        ...
        //            // 但对于当前项目，这个简化是可行的
        //            throw new IllegalStateException("JoinExecutor currently expects its direct
        // children to be SeqScanPlanNodes.");
        //        }
    }
