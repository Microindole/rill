...
/**
 * Manual storage demo utility.
 * This class must not run automatically as part of Spring Boot startup.
 */
public class ShellRunner {
    ...
    private void testBufferPoolReplacement() throws IOException {
        final String TEST_DB_FILE_REPLACEMENT = "rill_replacement.db";
