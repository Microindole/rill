...
@Service
public class SqlSnippetServiceImpl implements SqlSnippetService {

    private final SqlSnippetMapper sqlSnippetMapper;
    private final CurrentUserProvider currentUserProvider;

    public SqlSnippetServiceImpl(SqlSnippetMapper sqlSnippetMapper, CurrentUserProvider currentUserProvider) {
