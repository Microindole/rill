...
public class WorkspaceDashboardServiceImpl implements WorkspaceDashboardService {
    ...
    public WorkspaceDashboardServiceImpl(
    ...
    public WorkspaceDashboardResponse getDashboard() {
        ...
        return new WorkspaceDashboardResponse(
            sessions.size(),
            allHistory.size(),
            Math.toIntExact(sqlSnippetMapper.selectCount(new QueryWrapper<SqlSnippetEntity>().eq("owner_id", ownerId))),
            Math.toIntExact(demoScenarioMapper.selectCount(new QueryWrapper<DemoScenarioEntity>().eq("owner_id", ownerId))),
